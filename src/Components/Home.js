    ...
    <div className='Header'>
      ...
      <div className='business'>
        <div className='business-body'>
          <h1>You're a small business <br /> boss. And we're here for it.</h1>
          <p>Save up to 40% on select shipping and <br /> surcharges when you open a free account.</p>
          <a href='#'>Start Saving</a>
        </div>
        {/* <div className='business-image'>
        <img src="/image/fedexbg.jpg" alt='my image' />
        </div> */}
      </div>
